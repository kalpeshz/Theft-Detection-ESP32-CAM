...
int pirValue;
char auth[] = "goG8gMUN1pZxxzbVMSGt5Lv1OdFENhq1";
...
{
  pirValue = digitalRead(GPIO_NUM_13);
  if (pirValue) 
  { 
    ...
    Blynk.notify("==> Motion detected"); 
     delay(3000);  
  Blynk.email("kalpeshzurange33@gmail.com", "Theft Detection", "Motion Detected!");
